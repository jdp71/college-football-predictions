...
function populateWeek1Results() {
    ...
    // Week 1 actual results from our analysis
    const week1Results = [
        { home: 'Georgia', away: 'Marshall', homeScore: 38, awayScore: 0 },
        ...
        { home: 'Maryland', away: 'Florida Atlantic', homeScore: 39, awayScore: 7 },
        { home: 'Purdue', away: 'Ball State', homeScore: 31, awayScore: 0 },
        { home: 'Indiana', away: 'Old Dominion', homeScore: 27, awayScore: 14 },
        { home: 'Boston College', away: 'Fordham', homeScore: 66, awayScore: 10 },
        { home: 'UConn', away: 'Central Connecticut State', homeScore: 59, awayScore: 13 },
        { home: 'West Virginia', away: 'Robert Morris', homeScore: 45, awayScore: 3 },
        { home: 'Pittsburgh', away: 'Duquesne', homeScore: 61, awayScore: 9 },
        { home: 'Tulane', away: 'Northwestern', homeScore: 23, awayScore: 3 },
        { home: 'Kent State', away: 'Merrimack', homeScore: 21, awayScore: 17 },
        { home: 'Navy', away: 'VMI', homeScore: 52, awayScore: 7 }
    ];
